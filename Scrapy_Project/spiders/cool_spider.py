...
class Spiderman(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        #
        #
        # sql = "INSERT INTO dqrreport_housekeeping (UID,plot1,plot2,plot3,plot4,plot5,plot6,plot7,plot8,plot9,plot10,plot11,plot12,plot13,plot14) VALUES (2018020606,'"+hk1+"','"+hk2+"','"+hk3+"','"+hk4+"','"+hk5+"','"+hk6+"','"+hk7+"','"+hk8+"','"+hk9+"','"+hk10+"','"+hk11+"','"+hk12+"','"+hk13+"','"+hk14+"')"
        # mycursor.execute(sql)
        # mydb.commit()
        #
        # housekeep +=1
        ...
        #
        # sql = "INSERT INTO dqrreport_countrate (UID,crplot1,crimg1,crplot2,crimg2,crplot3,crimg3,crplot4,crimg4,crplot5,crimg5,crplot6,crimg6) VALUES (2018020606, '"+crp1+"', '"+cri1+"', '"+crp2+"', '"+cri2+"', '"+crp3+"', '"+cri3+"', '"+crp4+"', '"+cri4+"', '"+crp5+"', '"+cri5+"', '"+crp6+"', '"+cri6+"')"
        # mycursor.execute(sql)
        # mydb.commit()
        # countrate += 1
        ...
        # # pprint(dphimg3)
        #
        # sql = "INSERT INTO dqrreport_dph (quadA,quadB,quadC,quadD,UID) VALUES ('"+dphimg0+"', '"+dphimg1+"', '"+dphimg2+"', '"+dphimg3+"', 2018020606)"
        # mycursor.execute(sql)
        # mydb.commit()
        #
        # dphcount += 1
        ...
        #         b[8] == "dec_pnt":
        #     sql = "INSERT INTO dqrreport_obsinfo (date_obs,time_obs,date_end,time_end,obs_id,exposure,sourceid,observer,ra_pnt,dec_pnt,UID) VALUES ('" + obs[0] + "', '" + obs[1] + "', '" + obs[2] + "', '" + obs[3] + "', '" + obs[4] + "', 'NA', '" + obs[5] + "', '" + obs[6] + "', '" + obs[7] + "', '" + obs[8] + "', 2018020606)"
        #     mycursor.execute(sql)
        #     mydb.commit()
        #
        # if b[0] == "date-obs" and b[1] == "time-obs" and b[2] == "date-end" and b[3] == "time-end" and b[
        #     4] == "obs_id" and b[5] == "exposure" and b[6] != "sourceid" and b[7] == "observer" and b[8] == "ra_pnt" and \
        #         b[9] == "dec_pnt":
        #     sql = "INSERT INTO dqrreport_obsinfo (date_obs,time_obs,date_end,time_end,obs_id,exposure,sourceid,observer,ra_pnt,dec_pnt,UID) VALUES ('" + obs[0] + "', '" + obs[1] + "', '" + obs[2] + "', '" + obs[3] + "', '" + obs[4] + "', '" + obs[5] + "', ' ', '" + obs[7] + "', '" + obs[8] + "', '" + obs[9] + "', 2018020606)"
        #     mycursor.execute(sql)
        #     mydb.commit()
        #
        # if b[0] == "date-obs" and b[1] == "time-obs" and b[2] == "date-end" and b[3] == "time-end" and b[
        #     4] == "obs_id" and b[5] == "exposure" and b[6] == "sourceid" and b[7] != "observer" and b[8] == "ra_pnt" and \
        #         b[9] == "dec_pnt":
        #     sql = "INSERT INTO dqrreport_obsinfo (date_obs,time_obs,date_end,time_end,obs_id,exposure,sourceid,observer,ra_pnt,dec_pnt,UID) VALUES ('" + obs[0] + "', '" + obs[1] + "', '" + obs[2] + "', '" + obs[3] + "', '" + obs[4] + "', '" + obs[5] + "', '" + obs[6] + "', ' ', '" + obs[8] + "', '" + obs[9] + "', 2018020606)"
        #     mycursor.execute(sql)
        #     mydb.commit()
        #
        # if b[0] == "date-obs" and b[1] == "time-obs" and b[2] == "date-end" and b[3] == "time-end" and b[
        #     4] == "obs_id" and b[5] == "exposure" and b[6] == "sourceid" and b[7] == "observer" and b[8] != "ra_pnt" and \
        #         b[9] == "dec_pnt":
        #     sql = "INSERT INTO dqrreport_obsinfo (date_obs,time_obs,date_end,time_end,obs_id,exposure,sourceid,observer,ra_pnt,dec_pnt,UID) VALUES ('" + obs[0] + "', '" + obs[1] + "', '" + obs[2] + "', '" + obs[3] + "', '" + obs[4] + "', '" + obs[5] + "', '" + obs[6] + "', '" + obs[7] + "', ' ', '" + obs[9] + "', 2018020606)"
        #     mycursor.execute(sql)
        #     mydb.commit()
        #
        # if b[0] == "date-obs" and b[1] == "time-obs" and b[2] == "date-end" and b[3] == "time-end" and b[
        #     4] == "obs_id" and b[5] == "exposure" and b[6] == "sourceid" and b[7] == "observer" and b[8] == "ra_pnt" and \
        #         b[9] != "dec_pnt":
        #     sql = "INSERT INTO dqrreport_obsinfo (date_obs,time_obs,date_end,time_end,obs_id,exposure,sourceid,observer,ra_pnt,dec_pnt,UID) VALUES ('" + obs[0] + "', '" + obs[1] + "', '" + obs[2] + "', '" + obs[3] + "', '" + obs[4] + "', '" + obs[5] + "', '" + obs[6] + "', '" + obs[7] + "', '" + obs[8] + "', ' ', 2018020606)"
        #     mycursor.execute(sql)
        #     mydb.commit()
        #
        # if b[0] == "date-obs" and b[1] == "time-obs" and b[2] == "date-end" and b[3] == "time-end" and b[
